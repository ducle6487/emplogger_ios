//
//  InjectObservablePropertyWrapperTest.swift
//  
//
...
final class InjectObservablePropertyWrapperTest: XCTestCase, DependencyRegistrant, DependencyMocker {
    private var disposables = Set<AnyCancellable>()
    @InjectObservable(\.testObservableObject) var testObject: any SomeObservableTestProtocol
